      ...
      <div #pickerGroupLayer *ngFor="let group of data; let gIndex = index"
        ...
        <div class="picker-list">
          <div *ngIf="group.divider else ngIfElse"
            class="picker-item divider" [ngClass]="getItemClass(gIndex, 0, true)">
            {{ group.text }}
          </div>

          <ng-template #ngIfElse>
            <div *ngFor="let item of group.list; let iIndex = index"
...
export class DataPickerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('pickerHandleLayer', {read: ElementRef}) public pickerHandleLayer: ElementRef;
  ...
  triggerAboveLayerClick (ev, gIndex) {
    console.log('gIndexgIndex', gIndex)
  ...
  handleEventClick (ev) {
    ...
    console.log('ev.target.datase', ev.target.dataset)
  ...
  isCurrentItem (gIndex: any, iIndex) {
